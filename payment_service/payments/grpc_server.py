...
class PaymentService(payment_pb2_grpc.PaymentServiceServicer):
    def AllocateFee(self, request, context):
        try:
            ...
            # Check if fee structure already exists for this grade/year
    ...
    def AllocateFeeForStudent(self, request, context):
        try:
            ...
            student_fee = StudentFee.objects.create(
                student_id=request.student_id,  # cross-service reference
                fee_structure=fee_structure,
    ...
    def InitiatePayment(self, request, context):
        print(">>> gRPC InitiatePayment called with:", request)
        try:
    ...
    def SimulateRazorpayPayment(self, request, context):
        ...
        razorpay_payment_id = f"pay_{payment.id}XYZ"

        msg = f"{request.razorpay_order_id}|{razorpay_payment_id}"
    ...
    def GenerateReceipt(self, request, context):
        try:
            ...
            # Use student details sent from user_service
